...
#define RSI_TCP_IP_FEATURE_BIT_MAP (TCP_IP_FEAT_MDNSD | TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_HTTP_SERVER | TCP_IP_FEAT_EXTENSION_VALID)

//! To set custom feature select bit map
#define RSI_CUSTOM_FEATURE_BIT_MAP (CUSTOM_FEAT_DFS_CHANNEL_SUPPORT | FEAT_CUSTOM_FEAT_EXTENTION_VALID)

//! To set Extended custom feature select bit map
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP EXT_FEAT_RSA_KEY_WITH_4096_SUPPORT | EXT_FEAT_SSL_VERSIONS_SUPPORT

#define RSI_EXT_TCPIP_FEATURE_BITMAP (RSI_NUMBER_OF_SELECTS << 12 | EXT_TCP_IP_HTTP_SERVER_BYPASS)
...
#define TOTAL_SOCKETS                   8  //@ Total number of sockets. TCP TX + TCP RX + UDP TX + UDP RX
#define TOTAL_TCP_SOCKETS               6  //@ Total TCP sockets. TCP TX + TCP RX
#define TOTAL_UDP_SOCKETS               2  //@ Total UDP sockets. UDP TX + UDP RX
...
#define RSI_SOCKET_KEEPALIVE_TIMEOUT 10 // FIXME: Keep alive 시간 설정 변경
#define RSI_SOCKET_TCP_MAX_TRY_CNT   2
...
//! RSI_BAND_2P4GHZ(2.4GHz) or RSI_BAND_5GHZ(5GHz) or RSI_DUAL_BAND
#define RSI_CONFIG_EAP_BAND RSI_DUAL_BAND
