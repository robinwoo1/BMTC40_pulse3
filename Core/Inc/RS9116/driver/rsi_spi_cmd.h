...
#define RSI_RESET_TIMER1 rsi_driver_cb_non_rom->rsi_spiTimer1 = HAL_GetTick()
#define RSI_RESET_TIMER2 rsi_driver_cb_non_rom->rsi_spiTimer2 = HAL_GetTick()
#define RSI_RESET_TIMER3 rsi_driver_cb_non_rom->rsi_spiTimer3 = HAL_GetTick()
#define RSI_RESET_TIMER4 rsi_driver_cb_non_rom->rsi_spiTimer4 = HAL_GetTick()
#else
#define RSI_INC_TIMER_3  rsi_driver_cb_non_rom->rsi_spiTimer3
#define RSI_INC_TIMER_2  rsi_driver_cb_non_rom->rsi_spiTimer2
#define RSI_INC_TIMER_1  rsi_driver_cb_non_rom->rsi_spiTimer1
