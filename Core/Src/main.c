...
int main(void)
{
  ...
  //  usbGpioReset();             // USB GPIO Init                             TODO: After MX_GPIO_Init();
  //  PowerWakeUpJudge();         // Sleep -> Switch wake up or IWDG wake up   TODO: After MX_ADC1_Init() 
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, WIFI_RESET_Pin|LIGHT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(POWER_OFF_GPIO_Port, POWER_OFF_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SOUND_Pin|LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BAR_START_GPIO_Port, BAR_START_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : WIFI_RESET_Pin LIGHT_Pin */
  GPIO_InitStruct.Pin = WIFI_RESET_Pin|LIGHT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : DR_START_IN_Pin DR_LF_IN_Pin */
  GPIO_InitStruct.Pin = DR_START_IN_Pin|DR_LF_IN_Pin;
  ...
  /*Configure GPIO pin : BAR_GOODREAD_Pin */
  GPIO_InitStruct.Pin = BAR_GOODREAD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(BAR_GOODREAD_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : BAR_START_Pin */
  GPIO_InitStruct.Pin = BAR_START_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BAR_START_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : EEP_CS1_Pin */
  GPIO_InitStruct.Pin = EEP_CS1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(EEP_CS1_GPIO_Port, &GPIO_InitStruct);
